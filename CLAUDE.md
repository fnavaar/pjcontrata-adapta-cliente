...
- GoSkip: base de construção e preview.
- SkipCloud: persistência, autenticação e RBAC.
- Repositório: ainda não criado; a criação é uma ação posterior e exige autorização explícita.
- Testes automatizados: comandos ainda não definidos.

## Estado atual

Fase 1 planejada; F1-T01 é a única task elegível. Consulte `04_fase-atual/fase.md` e `04_fase-atual/specs/`.
