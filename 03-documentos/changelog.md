...
- Corrigido `02-Escopo-Definitivo.md` para delimitar o produto à aquisição própria da Digitoel; removida a interpretação de operação de mídia para clientes.
